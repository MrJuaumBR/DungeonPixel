...
def settings(game_state):
    ...
    while run:
        ...
        slider_padding_y = 16
        slider_x = volume_surface.x - slider_padding_x
        slider_y = volume_surface.y + volume_surface.height + slider_padding_y
        game_state.Slider_VolumePos, game_state.Slider_VolumePercentage = pme.draw_slider2(slider_x, slider_y, slider_width, [(35,35,35),(100,190,125),(200,200,200)],game_state.Slider_VolumePos,game_state.Slider_VolumePercentage, detail=True)
